 ...
 * 
 */
@WebServiceClient(name = "AlunoWebService", targetNamespace = "http://ws.exemplo.ftm.com.br/", wsdlLocation = "http://tsp3297128:8090/WS_Exemplo_04/AlunoWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ALUNOWEBSERVICE_QNAME = new QName("http://ws.exemplo.ftm.com.br/", "AlunoWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://tsp3297128:8090/WS_Exemplo_04/AlunoWebService?wsdl");
    ...
    public AlunoWeb getAlunoWebPort() {
        return super.getPort(new QName("http://ws.exemplo.ftm.com.br/", "AlunoWebPort"), AlunoWeb.class);
    }
    ...
    public AlunoWeb getAlunoWebPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.exemplo.ftm.com.br/", "AlunoWebPort"), AlunoWeb.class, features);
    }
